...
extension UIView {
    func applyArrowDialogAppearanceWithOrientation(frame: CGRect, arrowOrientation: UIImage.Orientation) {
        let shapeLayer = CAShapeLayer()
        shapeLayer.path = dialogBezierPathWithFrame(frame, arrowOrientation: arrowOrientation).cgPath
